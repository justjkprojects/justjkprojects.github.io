...
//Application Title
define('APP_TITLE', 'File Transfer Manager');
...
$auth_users = array(
    'administrator' => '$2y$10$YehQOZ263HBu0pq6NCv.s.NLl74OyHdQZJgLgoJ8h2dJCko2RYNg.', //pass@12323
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        <div class="card fat <?php echo fm_get_theme(); ?>">
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    ...
                                    <div class="mb-3">
                                        <button type="submit" id="submit" class="btn btn-success btn-block w-100 mt-4" role="button">
                                            <?php echo lng('Login'); ?>
                                        </button>
                                    </div>
                                </form>
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="#" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>"> <?php $year = date("Y"); echo $year; ?> All rights reserved.</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://github.com/prasathmani/tinyfilemanager" target="_blank" class="app-v-title"> File Transfer Manager <?php echo VERSION; ?></a></h3></p>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="#" class="float-right text-muted">File Transfer Manager <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="#" class="float-right text-muted">File Transfer Manager <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
